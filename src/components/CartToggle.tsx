...
const CartToggle: React.FC = () => {
  ...
  return (
    <div className="fixed left-3 right-3 bottom-[calc(env(safe-area-inset-bottom)+72px)] md:left-auto md:right-6 md:bottom-6 z-40">
        ...
        <div className="md:hidden rounded-2xl border border-white/80 bg-white/78 backdrop-blur-2xl px-3 py-2 shadow-[0_16px_36px_rgba(15,23,42,0.18)]">
          <div className="flex items-center justify-between text-[11px] text-slate-700">
            ...
            <span className={totalWeight >= MIN_WEIGHT_KG ? "font-bold text-green-700" : ""}>
              ...
              {totalWeight.toFixed(1)}kg/{MIN_WEIGHT_KG}kg
            </span>
